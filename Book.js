...
const imgCard3 = $(
'<img src="./picture/vintage-chemical-lab-books-closeup-70216103.webp">'
);
...
const title_3 = $(
  '<div class="title-3"><div class="line-1"></div><div class="line-2"></div></div>'
);
...
const title_4 = $(
  '<div class="title-4"><div class="line-1"></div><div class="line-2"></div></div>'
);
...
const categoresesBooks = function (e) {
  if (e.target.id == 1) {
    ...
    HistoricalArry[1].books.forEach((book, i) => {
      ...
      btnInformation.on("click", goToInformationBookHistory);
    });
...
function checkInput() {
  if (
    ...
    alert("Try Again Chick On your Data");
  }
}

function goToInformationBookHistory(e) {
  const page_info = $(`<div class="page-info">
   <div class="image-book"><img src="${
     HistoricalArry[1].books[e.target.id].imageSrc
   }"></div>
